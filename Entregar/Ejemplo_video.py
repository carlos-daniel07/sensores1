# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 16:53:50 2020
...
def traceDB(cnxnAzure,uuid,message):
 ...
 def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if variable1 < 10:
        ...
        return func.HttpResponse("Se ingresó un valor mal en el postman pero la funcion se ejecutó exitosamente",status_code=200)
